<html lang="en">
    ...
    <body>
        ...
        <div class="reservas">
            <a href="generalConc1"><div class="escenario"><h2>Escenario</h2></div></a>
            <a href="pistaAConc1"><div class="pista1"><h2>Pista A</h2></div></a>
            <a href="pistaBConc1"><div class="pista2"><h2>Pista B</h2></div></a>
            <a href="grada1Conc1"><div class="grada1"><h2>Grada 1</h2></div></a>
            <a href="grada2Conc1"><div class="grada2"><h2>Grada 2</h2></div></a>
            <a href="grada3Conc1"><div class="grada3"><h2>Grada 3</h2></div></a>
        </div>
        <div class="datos">
            <center>   
            <!-- @csrf -->
                <div class="inputBox" style="{{ session()->get( 'displayBlock' ) }}{{ session()->get( 'displayNone1' ) }}{{ session()->get( 'displayNone2' ) }}{{ session()->get( 'displayNone3' ) }}{{ session()->get( 'displayNone4' ) }}{{ session()->get( 'displayNone5' ) }}">
                    ...
                    <span id="text2">Entradas Disponibles: 15.500</span>
                ...
                <form id="formularioCompra" method="POST" action="{{ route('registro') }}"></form>
                    <div class="inputBox2" style="{{ session()->get( 'displayBlock1' ) }}{{ session()->get( 'displayNone2' ) }}">
                        ...
                        <span id="text2">Entradas Disponibles: 4.000</span>
                ...
                <form id="formularioCompra" method="POST" action="{{ route('registro') }}"></form>
                    <div class="inputBox4" style="{{ session()->get( 'displayBlock3' ) }}{{ session()->get( 'displayNone4' ) }}">
                        ...
                        <span id="text2">Entradas Disponibles: 2.500</span>
