<html lang="en">
    ...
    <body>
        ...
        <div class="reservas">
            <a href="generalConc3"><div class="escenario" style="{{ session()->get( 'color' ) }}{{ session()->get( 'colorNegro1' ) }}{{ session()->get( 'colorNegro2' ) }}{{ session()->get( 'colorNegro3' ) }}{{ session()->get( 'colorNegro4' ) }}{{ session()->get( 'colorNegro5' ) }}"><h2>Escenario</h2></div></a>
            <a href="pistaAConc3"><div class="pista1" style="{{ session()->get( 'agotado' ) }}{{ session()->get( 'colorAgotado' ) }}{{ $agotado6 }}{{ $colorAgotado6 }}{{ session()->get( 'color1' ) }}"><h2>Pista A</h2></div></a>
            <a href="pistaBConc3"><div class="pista2" style="{{ session()->get( 'agotado2' ) }}{{ session()->get( 'colorAgotado2' ) }}{{ $agotado7 }}{{ $colorAgotado7 }}{{ session()->get( 'agotado7' ) }}{{ session()->get( 'colorAgotado7' ) }}{{ session()->get( 'color2' ) }}"><h2>Pista B</h2></div></a>
            <a href="grada1Conc3"><div class="grada1" style="{{ session()->get( 'agotado3' ) }}{{ session()->get( 'colorAgotado3' ) }}{{ $agotado8 }}{{ $colorAgotado8 }}{{ session()->get( 'agotado8' ) }}{{ session()->get( 'colorAgotado8' ) }}{{ session()->get( 'color3' ) }}"><h2>Grada 1</h2></div></a>
            <a href="grada2Conc3"><div class="grada2" style="{{ session()->get( 'agotado4' ) }}{{ session()->get( 'colorAgotado4' ) }}{{ $agotado9 }}{{ $colorAgotado9 }}{{ session()->get( 'agotado9' ) }}{{ session()->get( 'colorAgotado9' ) }}{{ session()->get( 'color4' ) }}"><h2>Grada 2</h2></div></a>
            <a href="grada3Conc3"><div class="grada3" style="{{ session()->get( 'agotado5' ) }}{{ session()->get( 'colorAgotado5' ) }}{{ $agotado10 }}{{ $colorAgotado10 }}{{ session()->get( 'agotado10' ) }}{{ session()->get( 'colorAgotado10' ) }}{{ session()->get( 'color5' ) }}"><h2>Grada 3</h2></div></a>
        </div>
        <div class="datos">
            <center>   
        ...
        <form id="form" method="POST" action="{{ route('compraEntradaConc3PistaA') }}">
            @csrf
            ...
            <form id="form2" method="POST" action="{{ route('compraEntradaConc3PistaB') }}">
                @csrf
            ...
            <form id="form3" method="POST" action="{{ route('compraEntradaConc3Grada1') }}">
                @csrf
            ...
            <form id="form4" method="POST" action="{{ route('compraEntradaConc3Grada2') }}">
                @csrf
            ...
            <form id="form5" method="POST" action="{{ route('compraEntradaConc3Grada3') }}">
                @csrf
