...
class ControladorEntradasCine4 extends Controller
{
    ...
    $datos = Butacas::select('numButaca')->where('dia', $dia)->where('hora', $hora)->where('titulo', 'Shrek')->get();
    if(empty($datos)){
        $data1 = "";
        $data2 = "";
        $data3= "";
